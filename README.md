...
<p align="center">
  <strong>🏛️ 禁毒教育小程序 · 云展馆导览 · 互动体验 · 答题积分 · 静态可运行</strong>
</p>
...
<!-- 截图占位：请替换为真实项目截图 -->
<p align="center">
  <img src="docs/images/cover.png" width="900" alt="项目封面截图（占位）" />
</p>
...
- 静态数据驱动，可离线演示主流程
<p align="center">
  <img src="docs/images/feature-museum.png" width="900" alt="核心板块截图（占位）" />
</p>
...
- 结局积分奖励与本地记录联动
<p align="center">
  <img src="docs/images/feature-experience.png" width="900" alt="故事引擎截图（占位）" />
</p>
...
- 正确率、得分、学习记录本地统计
<p align="center">
  <img src="docs/images/feature-quiz.png" width="900" alt="答题系统截图（占位）" />
</p>
...
- 便于后续扩展本地题库和素材包
<p align="center">
  <img src="docs/images/feature-vr-audio.png" width="900" alt="图文展区截图（占位）" />
</p>
...
- 适配静态运行及后端联调两种模式
<p align="center">
  <img src="docs/images/feature-vr-audio.png" width="900" alt="VR语音截图（占位）" />
</p>
...
- 学习统计与记录可视化页面
<p align="center">
  <img src="docs/images/feature-points-gift.png" width="900" alt="积分礼品截图（占位）" />
</p>
